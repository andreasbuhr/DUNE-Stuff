...
class EigenMatrixInterface
  : public EigenContainerInterface< Traits >
{
public:
  typedef typename Traits::derived_type derived_type;
}; // class EigenMatrixInterface
...
template< class ElementImp = double >
class EigenRowMajorSparseMatrix
  : public MatrixInterface< EigenRowMajorSparseMatrixTraits< ElementImp > >
...
public:
  ...
  EigenRowMajorSparseMatrix(const size_type _rows,
                            ...
                            const SparsityPatternDefault& _pattern)
  ...
  EigenRowMajorSparseMatrix(const ThisType& other,
                            const Dune::Stuff::LA::SparsityPatternDefault& _pattern)
...
template< class ElementImp = double >
class EigenDenseMatrix
  : public MatrixInterface< EigenDenseMatrixTraits< ElementImp > >
...
template< class ElementImp = double>
class EigenDenseVector
  : public VectorInterface< EigenDenseVectorTraits< ElementImp > >
...
template< class ElementImp = double>
class EigenMappedDenseVector
  : public VectorInterface< EigenMappedDenseVectorTraits< ElementImp > >
...
std::shared_ptr< EigenRowMajorSparseMatrix< ElementType > > createIdentityEigenRowMajorSparseMatrix(const size_type _size)
{
  ...
  std::shared_ptr< EigenRowMajorSparseMatrix< ElementType > >
      ret = Dune::make_shared< EigenRowMajorSparseMatrix< ElementType > >(_size, _size, pattern);
  for (typename SparsityPatternDefault::size_type ii = 0; ii < _size; ++ii)
    ret->set(ii, ii, 1.0);
  return ret;
}
